    ...
    while True:
        ...
        if data:
            ...
            if time.time() > timeout:
                ...
                time.sleep(1)
                give_object_accordingly(item) #upon changing from give_object() into give_object_accordingly() the experimental condition is changed into functional rather then decorative.
                break    
