...
def react_to_offer():    
    ...
    b = 0 #counting variable for trial
    while True:
        establish_connection()
        if data:
            namepos_send()
            ...
            if b == 2:
                time.sleep(1)
                give_object(item) #upon changing this into give_object_accordingly() the experimental condition is changed into functional rather then decorative.
                break
